...
// import { ExpandBoxWarning } from '~/src/components/Elements/ExpandBox'
import FilterColumn from '~/common/components/FilterTable/Filter/FilterColumn'
// import FilterDateColumn from '~/src/components/Tables/FilterDateColumn'
...
export default function ReportStudentWarning() {
	...
	const columns = [
		...
		// 			<Link
		// 				href={{
		// 					pathname: '/customer/report/report-customer-test/student-detail',
		// 					query: { slug: 2 }
		// 				}}
		// 			>
	...
	return (
		<ExpandTable
			...
			// Extra={<StudyTimeForm showAdd={true} />}
			data={dataTable}
			columns={columns}
