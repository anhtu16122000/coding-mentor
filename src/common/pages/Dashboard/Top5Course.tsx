...
const Top5CourseChart = () => {
	...
	const getData = async () => {
		try {
			const res = await staticsticalApi.getTopPurpose(filters)
			if (res.status == 200) {
	...
	return (
		<Card
			className="shadow-sm w3-animate-right"
			title={
				<div className="flex items-center justify-between w-full">
					<div className="font-[500] mt-[2px]">Biểu đồ top mục đích học</div>
