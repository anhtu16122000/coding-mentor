...
const RoomsDetail = () => {
	...
	const theInfo = useSelector((state: RootState) => state.user.information)
	...
	const columns =
		is(theInfo).admin || is(theInfo).manager
			? [
					{
						title: 'Mã phòng',
						dataIndex: 'Code',
	...
	return (
		<>
			<PrimaryTable
				...
				Extra={is(theInfo).admin || is(theInfo).manager ? <RoomForm dataCenter={dataCenter} getDataRoom={getDataRoom} /> : ''}
				data={roomData}
