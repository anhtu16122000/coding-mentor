...
import { certificateApi } from '~/api/certificate-old/certificate'
import ModalCreate from './modal-create'
import CertificateStudent from './CertificateStudentTemplate'
...
const CourseStudents = () => {
	...
	const columns = [
		...
		},
		{
			...
			key: '',
			render: (data) => {
				return <ModalCreate getCertificate={getCertificate} parentData={data} />
			}
		}
	]
